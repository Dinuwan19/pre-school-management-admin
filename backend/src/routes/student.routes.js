...
router.get('/:id', authorizeRole(['SUPER_ADMIN', 'ADMIN', 'TEACHER']), studentController.getStudentById);
router.put('/:id', authorizeRole(['SUPER_ADMIN', 'ADMIN']), upload.fields([{ name: 'photo', maxCount: 1 }, { name: 'birthCert', maxCount: 1 }]), validate(studentSchema), studentController.updateStudent);
